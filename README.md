...
You have to design & build the backend for the application and the ability for the users to register, create a team, add players etc.
...
https://github.com/azaylamba/dream11 
